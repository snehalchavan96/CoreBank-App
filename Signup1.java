...
public class Signup1 extends JFrame implements ActionListener{
	...
	Signup1() {
		...
		dobTextField.setBounds(300, 180, 200, 30);
		add(dobTextField); 
		...
		other.setBounds(630, 300, 100, 30);
		...
		stateTextField.setBounds(300, 450, 400, 30);
		add(stateTextField);
	...
	public void actionPerformed(ActionEvent e) {
		...
		String formno=""+random; // to convert long to String
